#!/usr/bin/env python3
"""
Minimal FastAPI backend with GitHub integration (no Redis/auth required).
"""
...
from app.api.router_minimal import router as api_router
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("Starting Claude CLI Web UI server (minimal with GitHub)...")
